...
class MainUi(QtWidgets.QMainWindow):
	...
	def init_ui(self):
		...
		self.main_layout = QtWidgets.QGridLayout(self.main_widget)   # 设置窗口主部件布局为网格布局

		self.left_widget = QtWidgets.QWidget()  # 创建左侧部件
		self.left_widget.setObjectName('left_widget')
		self.left_layout = QtWidgets.QGridLayout(self.left_widget)  # 设置左侧部件布局为网格

		self.right_widget = QtWidgets.QWidget() # 创建右侧部件
		self.right_widget.setObjectName('right_widget')
		self.right_layout = QtWidgets.QGridLayout(self.right_widget) # 设置右侧部件布局为网格
