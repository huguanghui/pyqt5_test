...
pip --default-timeout=100 install PyQt5 PyQt5-tools pyyaml qtawesome xlwt --user
...
echo python "%DEMO_PYTHON_DIR%\tool_record02\test.py"
python "%DEMO_PYTHON_DIR%\tool_record02\test.py"
